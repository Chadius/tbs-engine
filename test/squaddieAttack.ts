...
describe('Squaddie creation', () => {
  it('Has Health and MaxHealth', () => {
    const soldier = new Squaddie('soldier', 5)
...
describe('Attacker can deal damage to Target Squaddie', () => {
  it('Allows attacker to strike target', () => {
    const attacker = new Squaddie('soldier',5, {strength:5, armor:0})
    const target = new Squaddie('soldier',5, {strength:1, armor:1})
  ...
  it('Allows counterattacks', () => {
    const attacker = new Squaddie('soldier',5, {strength:5, armor:0})
    const target = new Squaddie('soldier',5, {strength:8, armor:1})
...
describe('Attacks have a chance to miss', () => {
  it('Knows it hits if attacks always hit', () => {
    const attacker = new Squaddie('soldier',5, {strength:20, armor:0})
    const target = new Squaddie('soldier',5, {strength:1, armor:1})
  ...
  it('Knows it will hit if attacker aim is too high', () => {
    const attacker = new Squaddie('soldier',5, {strength:20, armor:0, aim: 20})
    const target = new Squaddie('soldier',5, {strength:1, armor:1})
  ...
  it('Knows it will miss if target dodge is too high', () => {
    const attacker = new Squaddie('soldier',5, {strength:20, armor:0})
    const target = new Squaddie('soldier',5, {strength:1, armor:1, dodge: 20})
